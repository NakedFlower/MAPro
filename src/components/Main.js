              ...
              <Row gutter={[40, 40]}>
                  ...
                  >
                    ...
                    <div style={{ textAlign: 'left' }}>
                      <Paragraph style={{ color: '#666', fontSize: '16px', lineHeight: '1.7', marginBottom: '20px' }}>
                        음식점, 카페, 편의점, 약국, 펜션, 헤어샵, 병원 등 <strong style={{color: '#1890ff'}}>8개 업종</strong>에 대해 
                        사람들이 실제로 중요하게 생각하는 <strong style={{color: '#1890ff'}}>특징(Feature)</strong>을 기반으로 추천
                      </Paragraph>
                ...
                <Col xs={24} lg={8}>
                  ...
                  >
                    ...
                    <div style={{ textAlign: 'left' }}>
                      <Paragraph style={{ color: '#666', fontSize: '16px', lineHeight: '1.7', marginBottom: '20px' }}>
                        추천받은 매장에 대한 <strong style={{color: '#52c41a'}}>빠른 질의응답</strong> 가능<br /><br />
                        위치, 운영시간, 메뉴/서비스 같은 정보도 <strong style={{color: '#52c41a'}}>대화형으로 확인</strong> 가능
                      </Paragraph>
                ...
                <Col xs={24} lg={8}>
                  ...
                  >
                    ...
                    <div style={{ textAlign: 'left' }}>
                      <Paragraph style={{ color: '#666', fontSize: '16px', lineHeight: '1.7', marginBottom: '20px' }}>
                        <strong style={{color: '#722ed1'}}>리뷰/평점/실사용 데이터</strong> 기반으로 추천 정확도 업그레이드<br /><br />
                        쓰면 쓸수록 나에게 맞는 매장을 더 잘 찾아주는 <strong style={{color: '#722ed1'}}>개인화 알고리즘</strong>
                      </Paragraph>
